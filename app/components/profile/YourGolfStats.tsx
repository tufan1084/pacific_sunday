...
interface YourGolfStatsProps {
  golfPassport?: any;
}

export default function YourGolfStats({ golfPassport }: YourGolfStatsProps) {
  const stats = [
    {
      icon: "index",
      value: golfPassport?.handicap || GOLF_STATS[0].value,
      label: "Handicap Index",
    },
    {
      icon: "score",
      value: golfPassport?.bestScore || GOLF_STATS[2].value,
      label: "Best Score Ever",
    },
    {
      icon: "home",
      value: golfPassport?.homeCourse || GOLF_STATS[1].value,
