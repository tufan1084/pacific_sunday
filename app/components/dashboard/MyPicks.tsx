...
export default function MyPicks({ picks, totalPicked, totalSlots, tournamentId }: MyPicksProps) {
  return (
    <div style={cardStyle}>
        ...
        <div key={pick.tier}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", minHeight: "clamp(48px, 4vw, 55px)", paddingTop: "4px", paddingBottom: "4px" }}>
            ...
            {pick.status === "picked" ? (
              ...
              <Link href={`/fantasy-golf/${tournamentId}`} style={{ backgroundColor: "#E8C96A", color: "#060D1F", padding: "4px 16px", borderRadius: "5px", fontSize: "clamp(12px, 1.2vw, 14px)", fontWeight: 500, textDecoration: "none", flexShrink: 0, marginLeft: "8px" }}>
                Pick
              </Link>
            ) : (
              <Link href="/fantasy-golf" style={{ backgroundColor: "#E8C96A", color: "#060D1F", padding: "4px 16px", borderRadius: "5px", fontSize: "clamp(12px, 1.2vw, 14px)", fontWeight: 500, textDecoration: "none", flexShrink: 0, marginLeft: "8px" }}>
                Pick
              </Link>
            )}
          </div>
