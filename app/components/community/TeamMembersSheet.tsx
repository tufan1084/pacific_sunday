...
import { IoClose, IoEarthOutline, IoLockClosedOutline, IoSearch, IoSettingsOutline, IoPersonAddOutline, IoNotificationsOutline, IoImageOutline, IoLinkOutline } from "react-icons/io5";
    ...
    >
      ...
      {view === "invite" && (
        <div>
          ...
          >
            {copied ? <FiCheck size={16} /> : <IoLinkOutline size={16} />}
            {copied ? "Link Copied!" : "Copy Invite Link"}
          </button>

          <div style={{ borderBottom: "1px solid rgba(255,255,255,0.08)", marginBottom: "16px", paddingBottom: "12px" }}>
            <div style={{ color: "#888", fontSize: "11px", textAlign: "center" }}>OR</div>
          </div>
