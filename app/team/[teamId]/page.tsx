...
import { FiLock, FiGlobe, FiArrowLeft, FiCopy, FiCheck } from "react-icons/fi";
...
export default function TeamPreviewPage() {
  ...
  const isAdmin = user && team.isMember && team.role === "admin";
        ...
        <div style={{ backgroundColor: "#13192A", borderRadius: "8px", padding: "28px 24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
            <div style={{
              ...
              {team.imageUrl
                ? <Image src={resolveMediaUrl(team.imageUrl)} alt="" width={64} height={64} style={{ width: "100%", height: "100%", objectFit: "cover" }} unoptimized />
          ...
          <div style={{ backgroundColor: "rgba(232,201,106,0.08)", border: "1px solid rgba(232,201,106,0.2)", borderRadius: "6px", padding: "16px", marginBottom: "20px" }}>
            <div style={{ color: "#E8C96A", fontSize: "14px", fontWeight: 500, marginBottom: "8px" }}>
            ...
            <div style={{ color: "#94A3B8", fontSize: "12px", lineHeight: 1.6 }}>
              ...
              <ol style={{ marginTop: "8px", marginLeft: "20px", lineHeight: 1.8 }}>
                <li>Purchase a Pacific Sunday golf bag</li>
                <li>Register your bag via NFC scan</li>
          ...
          <button
            onClick={() => router.push(`/login?redirect=/team/${teamId}`)}
            style={{
              width: "100%",
    ...
    <div style={{ maxWidth: "640px", margin: "0 auto", padding: "20px", fontFamily: "var(--font-poppins), sans-serif" }}>
      ...
      <div style={{ backgroundColor: "#13192A", borderRadius: "8px", padding: "28px 24px" }}>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
          {/* Copy Invite Link Button (Admin Only) */}
          {isAdmin && (
            <button
