  ...
  return (
    <div style={{ fontFamily: "var(--font-poppins), sans-serif" }}>
      ...
      {tiers.length > 0 && !isLocked && !picksLoading && (
        <div style={{ marginTop: "20px", display: "flex", flexDirection: "column", gap: "10px", paddingBottom: "calc(32px + env(safe-area-inset-bottom))" }}>
          <div style={{ display: "flex", flexDirection: isLg ? "row" : "column", gap: "10px" }}>
            <button
              onClick={handleSave}
